...
export function AvatarCard({ className, text }: any) {
  return (
    <div
      className={`h-[173px] md:h-[213px] w-[301px] p-4 md:p-8 rounded-lg bg-white
               border-border_gray border absolute ${className} `}
    >
      <div className="flex items-center gap-2">
        <Avatar />
        <p className="font-bold text-[1rem] md:text-[1.15rem] text-black">Adeola Fatoyinbo</p>
      </div>
      ...
      <p className="text-[.5rem] md:text-[.8rem] text-[#666666] leading-normal mt-4">
        {text
          ? text
